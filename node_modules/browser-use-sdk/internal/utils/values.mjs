...
export const ensurePresent = (value) => {
    if (value == null) {
        throw new BrowserUseError(`Expected a value to be given but received ${value} instead.`);
    }
    return value;
};
export const validatePositiveInteger = (name, n) => {
    if (typeof n !== 'number' || !Number.isInteger(n)) {
        throw new BrowserUseError(`${name} must be an integer`);
    }
    if (n < 0) {
...
export const coerceInteger = (value) => {
    ...
    throw new BrowserUseError(`Could not coerce ${value} (type: ${typeof value}) into a number`);
};
