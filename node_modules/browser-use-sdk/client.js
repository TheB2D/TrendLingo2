...
var _BrowserUse_instances, _a, _BrowserUse_encoder, _BrowserUse_baseURLOverridden;
...
const agent_profiles_1 = require("./resources/agent-profiles.js");
const browser_profiles_1 = require("./resources/browser-profiles.js");
...
class BrowserUse {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('BROWSER_USE_BASE_URL'), apiKey = (0, env_1.readEnv)('BROWSER_USE_API_KEY'), ...opts } = {}) {
        _BrowserUse_instances.add(this);
        _BrowserUse_encoder.set(this, void 0);
        this.users = new API.Users(this);
        this.tasks = new API.Tasks(this);
        this.sessions = new API.Sessions(this);
        this.browserProfiles = new API.BrowserProfiles(this);
        this.agentProfiles = new API.AgentProfiles(this);
        if (apiKey === undefined) {
            throw new Errors.BrowserUseError("The BROWSER_USE_API_KEY environment variable is missing or empty; either provide it, or instantiate the BrowserUse client with an apiKey option, like new BrowserUse({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
            ...opts,
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('BROWSER_USE_LOG'), "process.env['BROWSER_USE_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _BrowserUse_encoder, Opts.FallbackEncoder, "f");
    ...
    async authHeaders(opts) {
        return (0, headers_1.buildHeaders)([{ 'X-Browser-Use-API-Key': this.apiKey }]);
    }
    /**
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new Errors.BrowserUseError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
    getUserAgent() {
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _BrowserUse_instances, "m", _BrowserUse_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _BrowserUse_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.BrowserUse = BrowserUse;
_a = BrowserUse, _BrowserUse_encoder = new WeakMap(), _BrowserUse_instances = new WeakSet(), _BrowserUse_baseURLOverridden = function _BrowserUse_baseURLOverridden() {
    return this.baseURL !== 'https://api.browser-use.com/api/v2';
};
BrowserUse.BrowserUse = _a;
BrowserUse.DEFAULT_TIMEOUT = 60000; // 1 minute
BrowserUse.BrowserUseError = Errors.BrowserUseError;
BrowserUse.APIError = Errors.APIError;
BrowserUse.APIConnectionError = Errors.APIConnectionError;
BrowserUse.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
BrowserUse.APIUserAbortError = Errors.APIUserAbortError;
BrowserUse.NotFoundError = Errors.NotFoundError;
BrowserUse.ConflictError = Errors.ConflictError;
BrowserUse.RateLimitError = Errors.RateLimitError;
BrowserUse.BadRequestError = Errors.BadRequestError;
BrowserUse.AuthenticationError = Errors.AuthenticationError;
BrowserUse.InternalServerError = Errors.InternalServerError;
BrowserUse.PermissionDeniedError = Errors.PermissionDeniedError;
BrowserUse.UnprocessableEntityError = Errors.UnprocessableEntityError;
BrowserUse.toFile = Uploads.toFile;
BrowserUse.Users = users_1.Users;
BrowserUse.Tasks = tasks_1.Tasks;
BrowserUse.Sessions = sessions_1.Sessions;
BrowserUse.BrowserProfiles = browser_profiles_1.BrowserProfiles;
BrowserUse.AgentProfiles = agent_profiles_1.AgentProfiles;
