...
class BrowserProfiles extends resource_1.APIResource {
    /**
    ...
    retrieve(profileID, options) {
        return this._client.get((0, path_1.path) `/browser-profiles/${profileID}`, options);
    }
    /**
    ...
    update(profileID, body, options) {
        return this._client.patch((0, path_1.path) `/browser-profiles/${profileID}`, { body, ...options });
    }
    /**
    ...
    delete(profileID, options) {
        return this._client.delete((0, path_1.path) `/browser-profiles/${profileID}`, {
            ...options,
