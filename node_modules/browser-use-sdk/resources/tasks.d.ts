...
import { type TaskCreateParamsWithSchema, type TaskViewWithSchema } from "../lib/parse.js";
export declare class Tasks extends APIResource {
     ...
     */
    create<T extends ZodType>(body: TaskCreateParamsWithSchema<T>, options?: RequestOptions): APIPromise<TaskCreateResponse>;
    ...
    stream(taskId: string, options?: RequestOptions): AsyncGenerator<{
        event: 'status';
        data: TaskView;
    }>;
    /**
     ...
     */
    run<T extends ZodType>(body: TaskCreateParamsWithSchema<T>, options?: RequestOptions): APIPromise<TaskViewWithSchema<T>>;
...
export declare namespace TaskCreateParams {
    ...
    interface AgentSettings {
        llm?: 'gpt-4.1' | 'gpt-4.1-mini' | 'o4-mini' | 'o3' | 'gemini-2.5-flash' | 'gemini-2.5-pro' | 'claude-sonnet-4-20250514' | 'gpt-4o' | 'gpt-4o-mini' | 'llama-4-maverick-17b-128e-instruct' | 'claude-3-7-sonnet-20250219';
